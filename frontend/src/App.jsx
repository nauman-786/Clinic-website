...
import { Calendar, Clock, MapPin, Phone, ShieldCheck, Stethoscope, Sparkles, ChevronRight, CheckCircle2, Award, Menu, X } from 'lucide-react';
...
function App() {
  ...
  useEffect(() => {
    if (view === 'admin') fetchAppointments();
  }, [view]);
      ...
      <nav className="fixed w-full top-0 z-50 bg-white/90 backdrop-blur-lg border-b border-gray-100 shadow-sm transition-all">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden lg:flex space-x-8 items-center">
            ...
            <button onClick={() => setView('admin')} className={`font-bold text-sm uppercase tracking-wider transition hover:text-blue-600 ${view === 'admin' ? 'text-blue-600' : 'text-gray-500'}`}>Staff Login</button>
          ...
          <AnimatedSection>
            <div className="flex justify-between items-center mb-10 border-b border-gray-200 pb-8">
              <div>
                ...
                <p className="text-gray-500 mt-2 text-lg">Live booking system for Khattak Clinic reception.</p>
              </div>
